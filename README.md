...
Should be used with [dataloader-sequelize](https://github.com/nholuongut/dataloader-sequelize) to avoid N+1 queries
...
Please take a look at [the tests](https://github.com/nholuongut/graphql-sequelize/blob/master/test/integration/resolver.test.js) to best get an idea of implementation.
